...
<div class="container posts">
    <div class="row">
        <div class="col-sm-12"><h1 class="page-header"><?=lang('services')?></h1></div>
    </div>
    <div class="row">
        <?PHP foreach($class->find_service() as $row): ?>
            <div class="col-sm-12">
                <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    ...
                    <a href="<?=site_url('site/services/?id='.$row[tpl_post::id()])?>" class="btn btn-2 btn-sm"><?=lang('Read_More')?></a>
                </div>
